...
namespace HugePointCloudConduit2Tester
{

	public class HPC2Conduit : Rhino.Display.DisplayConduit
	{
	...
	public class HugePointCloudConduit2TesterCommand : Command
	{
		public HugePointCloudConduit2TesterCommand()
		{
		...
		public static HugePointCloudConduit2TesterCommand Instance
		{
			get; private set;
		}
		...
		{
			get { return "HugePointCloudConduit2Tester"; }
		}

		HPC2Conduit cnd = new HPC2Conduit();
